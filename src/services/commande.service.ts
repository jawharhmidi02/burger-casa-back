...
//   try {
//     const payLoad = (await this.jwtService.decode(token)) as {
//       id: string;
//     };
...
//     } else {
//       if (orderToUpdate.status === 'Canceled') {
//         throw new Error('Order not found or already canceled or verified');
//       }
//       throw new Error('Order already been Verified');
//     }
...
//     const orderToUpdate = await this.commandeRepository.findOne({
//       where: { id: payLoad.id, status: 'Waiting to be Verified...' },
//     });
...
//       );
//     } else {
//       throw new Error('Order not found or already verified');
//     }
...
//       Order: data,
//       whatsapp: await whatsappResponse.data,
//     };
//   } catch (error) {
//     console.log(error);
